...
/**
 * Given 2 D array, that is filled with integers. Also given +ve intger
 * size. Return maximum sum that can be generated from a submatrix with dimensions
 * size * size.
 */
public class MaximumSumSubmatrix {
    // O(w * h) time | O(w * h) space - where w
    // is the width of the matrix and h is the height
